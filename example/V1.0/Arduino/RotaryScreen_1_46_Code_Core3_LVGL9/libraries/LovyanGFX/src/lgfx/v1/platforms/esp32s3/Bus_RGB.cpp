...
//----------------------------------------------------------------------------
  ...
  {
    // ESP32 Arduino Core 3.x (IDF 5.x) exposes GPIO muxing through the
    // public driver helper; the former HAL iomux helper was removed.
    // Arduino Core 3.3.8 still provides the compatibility iomux symbol.
    gpio_iomux_out((uint8_t)pin, PIN_FUNC_GPIO, false);
