...
// Use the UI generated for this sketch explicitly.  A library named `UI`
// installed in the user's global Arduino libraries directory can otherwise
// win the include search and expose a different set of widget symbols.
