...
void ui_Screen2_screen_init(void)
{
    ...
    lv_obj_set_style_arc_img_src(ui_VolumeArc, &ui_img_bar_white_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_arc_img_src(ui_VolumeArc, &ui_img_bar_bule_png, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    ui_VolumeImage = lv_img_create(ui_Screen2);
    lv_img_set_src(ui_VolumeImage, &ui_img_247194651);
    ...
    lv_obj_clear_flag(ui_VolumeImage, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
